	...
	<div class="col-md-9 animated bounce">
		...
		<form class="form-profile">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" readonly class="form-control-plaintext"
						value="${user.hoTen }" id="staticFullName">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" readonly class="form-control-plaintext"
						value="${user.email }" id="staticEmail">
				</div>
			</div>

			<div class="form-group row">
				<label for="staticPhone" class="col-sm-2 col-form-label">Số
					điện thoại</label>
				<div class="col-sm-10">
					<input type="text" readonly class="form-control-plaintext"
						value="${user.soDienThoai }" id="staticPhone">
				</div>
			</div>

			<div class="form-group row">
				<label for="staticAddress" class="col-sm-2 col-form-label">Địa
					chỉ</label>
				<div class="col-sm-10">
					<input type="text" readonly class="form-control-plaintext"
						value="${user.diaChi }" id="staticAddress">
				</div>
			</div>
		</form>
	</div>
