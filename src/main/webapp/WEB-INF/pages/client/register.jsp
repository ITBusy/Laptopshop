...
<body>
	...
	<div class="login-page">
		<div class="form">
			<%--@elvariable id="newUser" type="com.laptopshop.controller"--%>
			<form:form method="POST" action='register' modelAttribute="newUser">
				...
				<div class="form-group">
					<form:input type="password" path="confirmPassword" class="form-control" placeholder="Nhắc lại mật khẩu" required="required"></form:input>
					<form:errors class="error" path="confirmPassword"></form:errors>
				</div>
