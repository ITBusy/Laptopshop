...
public class CheckOutController {
	...
	public String checkoutPage(HttpServletRequest res,Model model) {
		...
		if(auth == null || auth.getPrincipal() == "anonymousUser")     //Lay tu cookie
		{
			...
			listsp = CartController.getSanPhams(quanity, cl, idList, sanPhamService);
		}else     //Lay tu database
		{
			CartController.getGioHang(currentUser, quanity, listsp, gioHangService, chiMucGioHangService);
		}
	...
	public String thankyouPage(@ModelAttribute("donhang") DonHang donhang ,
